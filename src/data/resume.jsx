  ...
  en: [
    {
      ...
      description:
        "Lead developer for a Mikrotik RouterOS SD-WAN platform. Architecting scalable cloud infrastructure with Laravel, Nuxt.js, and AWS microservices (Lambda, API Gateway, SNS). Also writing RouterOS scripts for router configuration. Implemented AI-driven network diagnostics based on usage patterns.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "Leading a full platform migration from CodeIgniter to Django for a supplier-to-webshop data mapping system. Building and maintaining integrations across REST, SOAP, JSON, XML, and FTP for major e-commerce platforms. Introduced advanced monitoring and retry mechanisms ensuring highly reliable daily synchronisation.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "Developing e-commerce API integrations for an AI-powered PIM startup that uses AI to enrich product information. Building backend services with Django and the frontend with RemixJS to support rapid growth. Designed scalable RESTful APIs and webhook pipelines that empower non-technical members to manage integrations.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "Built a highly configurable web scraping dashboard and e-commerce management tools for platforms like Magento, CCVShop, and WordPress using Django, NiceGUI, and React. Automated data collection and synchronisation pipelines. Built advanced, user-friendly data extraction rules requiring zero code entirely from operators.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "Leading Klaviyo e-mail marketing integrations for CMS platforms without standard connectors. Building custom event tracking via Google Tag Manager for Shopify, WooCommerce, Lightspeed, and CCVShop. Also developing internal automations. Created internal tools that significantly reduced manual effort for the marketing team.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "Tackled big data challenges for a major retail chain. Built data pipelines and analytical models using SQL, Azure Data Factory, Python, Pandas, and NumPy. Gained deep expertise in data manipulation and a broader tech perspective. Derived critical business insights from large-scale supply chain data using advanced analytical models.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "IT consultant deployed at enterprise clients including ING and government agencies. Learned rigorous testing methodologies (unit, integration, e2e) and agile practices that shaped my approach to code quality across all subsequent projects. These testing and quality principles became foundational to my engineering approach.",
      extendedDescription:
    ...
    },
    {
      ...
      description:
        "Frontend developer building government web applications with Angular. Led the AngularJS to Angular migration requiring deep knowledge of both frameworks. Set up CI/CD pipelines for continuous delivery and learned to navigate large organisational structures. Executed a massive framework migration with zero disruption to millions of citizens relying on these services.",
      extendedDescription:
  ...
  nl: [
    {
      ...
      skills: ["Laravel", "Nuxt.js", "AWS", "PHP", "Docker"],
      description:
        "Lead developer voor een Mikrotik RouterOS SD-WAN-platform. Microservices ontwerpen met Laravel, Nuxt.js en AWS (Lambda, API Gateway, SNS). Ik heb ook RouterOS-scripts geschreven voor routerconfiguratie en AI-functies gebouwd. Daarnaast ben ik medeverantwoordelijk voor het implementeren van AI-oplossingen voor intelligente netwerkdiagnostiek.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["Django", "Python", "REST", "SOAP", "CodeIgniter"],
      description:
        "Ontwikkelaar voor een platform dat leverancier-naar-webshop synchronisaties verzorgd. Ik help bij de volledige platformmigratie van CodeIgniter naar Django. Integraties bouwen en onderhouden via REST, SOAP, JSON, XML en FTP voor grote e-commerce platformen. Ik heb tevens geavanceerde monitoring en retry-mechanismen gëintroduceerd voor uiterst betrouwbare dagelijkse synchronisatie.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["Django", "RemixJS", "Python", "REST API"],
      description:
        "E-commerce API-integraties ontwikkelen voor een AI-aangedreven PIM-startup die AI inzet om productinformatie te verrijken. Backendservices bouwen met Django en frontend met RemixJS om snelle groei te ondersteunen. Ook ontwierp ik schaalbare pipelines waarmee niet-technische medewerkers zelfstandig integraties kunnen beheren.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["Django", "NiceGUI", "React", "Python"],
      description:
        "Een configureerbaar web scraping dashboard en e-commerce beheertools gebouwd voor platformen als Magento, CCVShop en WordPress met Django, NiceGUI en React. Dataverzamelings- en synchronisatiepipelines geautomatiseerd. Dit dashboard stelde gebruikers in staat om complexe data-extracties uit te voeren zonder programmeerkennis te benodigen.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["Klaviyo", "GTM", "Shopify", "WooCommerce", "JavaScript"],
      description:
        "Ontwikkelen van Klaviyo e-mailmarketingintegraties voor CMS-platformen zonder standaard connectors. Event tracking bouwen via Google Tag Manager voor Shopify, WooCommerce, Lightspeed en CCVShop. Interne automatiseringen ontwikkelen. Deze interne scripts en tools hebben de handmatige werkdruk voor het marketingteam aanzienlijk verlaagd.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["SQL", "Azure", "Python", "Pandas", "NumPy"],
      description:
        "Big data-vraagstukken aangepakt voor grote retailketen. Datapipelines en analytische modellen gebouwd met SQL, Azure Data Factory, Python, Pandas en NumPy. Expertise opgedaan in datamanipulatie en een breder technisch perspectief verkregen. Hierdoor konden inzichten uit grootschalige supply chain-data direct complexe zakelijke beslissingen onderbouwen.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["Java", "Angular", "Agile", "Testing"],
      description:
        "IT-consultant ingezet bij enterprise-klanten waaronder ING en overheidsinstanties. Rigoureuze testmethodologieën geleerd (unit, integratie, e2e) en agile werkwijzen die mijn aanpak van codekwaliteit in alle volgende projecten hebben gevormd. De hier opgedane rigoureuze test- en kwaliteitsprincipes vormen hiervoor de basis.",
      extendedDescription:
    ...
    },
    {
      ...
      skills: ["Angular", "TypeScript", "AngularJS", "CI/CD"],
      description:
        "Frontend developer voor overheidswebapplicaties met Angular. De migratie van AngularJS naar Angular geleid, wat diepgaande kennis van beide frameworks vereiste. CI/CD-pipelines opgezet en geleerd te navigeren binnen grote organisatiestructuren. Deze zorgvuldige, gefaseerde migratie voorkwam succesvol enige verstoring voor de miljoenen burgers die het gebruiken.",
      extendedDescription:
